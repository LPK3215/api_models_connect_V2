...
from src.local.api_client import get_rate_limiter, get_client_pool
from src.local.image_utils import get_image_url, get_image_files
from src.local.result_handler import (
...
def _process_single_image(
    ...
    # 非流式版本（保留原有逻辑）
    from src.local.result_handler import extract_text_from_message, parse_json_from_model_output
